...
//    0x580003C9,  // ldr x9,  =g_drtm_acs_dl_result
    0x58000409,  // ldr x9,  =g_drtm_acs_dl_result
    0xF9000120,  // str x0,  [x9]
    0xF9000521,  // str x1,  [x9, #8]
//    0x580003A9,  // ldr x9,  =g_drtm_acs_dl_saved_state
    0x580003E9,  // ldr x9,  =g_drtm_acs_dl_saved_state
...
int64_t val_drtm_init_drtm_params(DRTM_PARAMETERS *drtm_params)
{
    ...
    if (mmu_on) {
      ...
      val_memcpy((void *)dlme_image_addr, (void *)g_drtm_acs_dlme_mmu_off, g_drtm_acs_dlme_mmu_off_size);
      val_pe_cache_clean_invalidate_range((uint64_t)dlme_image_addr, (uint64_t)g_drtm_acs_dlme_mmu_off_size);
    }
